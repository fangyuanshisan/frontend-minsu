        ...
        <div :key="index">
          <button v-if="day !== 0">
            <a
              ...
              v-if="(trainDateFullList.includes(day))"
              class="active"
...
.drop-down-y::-webkit-scrollbar,
.drop-down-m::-webkit-scrollbar {
  display: none;
}
.drop-down-y {
}
...
.drop-down-y a.active,
.drop-down-m a.active {
  color: #fff;
  background-color: #0a81e5;
  border-radius: 5px;
}
